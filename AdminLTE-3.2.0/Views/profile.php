          ...
          <div class="col-md-3">
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="../dist/img/Perfil/user9-.jpg"
                       alt="User profile picture">
                </div>

                <h3 class="profile-username text-center">Erika Rivera</h3>

                <p class="text-muted text-center">Tecnologo: Analisis y Desarrollo de Software</p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  Tecnologo: Analisis y Desarrollo de Software SENA
                </p>
                ...
                <p class="text-muted">Boyaca, Colombia</p>
